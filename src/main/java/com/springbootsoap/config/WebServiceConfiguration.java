...
public class WebServiceConfiguration extends WsConfigurerAdapter {
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema employeeSchema) {
		...
		wsdlDefinition.setPortTypeName("allServiceSoapHttp");
		wsdlDefinition.setLocationUri("/allService");
		wsdlDefinition.setTargetNamespace("http://com.springbootsoap.allapis");
